...
### BCP
BCP<-read.table("/home/nostromo/data/pepe/20_SEÑALES_SIGNALS_BED_METHODS/h3k36me3_hg19/BCP/BCP_results_ultima.bed_region.bed")
...
CCAT<-read.table("/home/nostromo/data/pepe/20_SEÑALES_SIGNALS_BED_METHODS/h3k36me3_hg19/CCAT/CCAT_results_win10000.bed_region.bed")
...
## JAMM
JAMM<-read.table("/home/nostromo/data/pepe/20_SEÑALES_SIGNALS_BED_METHODS/h3k36me3_hg19/JAMM/filtered.peaks.narrowPeak")
JAMM<-read.table("/home/nostromo/data/pepe/20_SEÑALES_SIGNALS_BED_METHODS/h3k36me3_hg19/JAMM/selected_JAMM_h3k36me3_hg19.narrowPeak")
...
write.table(porcentajes_df, file="/home/nostromo/data/pepe/39_h3k36me3_hg19/porcentajes_cobertura_h3k36me3_hg19.txt", col.names=T, sep="\t", quote=F)
